...
**Scope:** This is a **requirements** plan for the custd-sdk team. It documents exactly what CouriB needs and the verification each fix must pass. It does not prescribe the repo-split (that stays [deferred](future/2026-06-16-sdk-repo-split_plan.md)).
