...
export type ProducerProvisionCreate = {
    ...
    environment?: string;
    scopes?: string[];
    scopeTemplate?: "events" | "schemas" | "managed-audit" | "managed-audit-reporting-read" | "managed-audit-reporting-subject-insight" | "managed-audit-event-read";
    metadata?: Record<string, string>;
};
...
export declare class CustdClient {
    ...
    readonly analytics: AnalyticsEventClient;
    private baseUrl;
    private getToken;
    private fetchImpl;
