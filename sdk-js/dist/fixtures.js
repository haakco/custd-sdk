 ...
 */
export function readLifecycleFixture(namespace, name) {
    ...
    try {
        ...
        throw new Error(`custd-sdk: lifecycle fixture ${namespace}/${name} not found: ${err.message}`);
    }
}
