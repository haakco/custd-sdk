...
const mobileNetworkStates = ["offline", "online", "unknown"];
...
export function createMobileEvent(input) {
...
function assertRequiredEventFields(input) {
...
function assertMobileSubject(subject) {
...
function assertMobileContext(context) {
